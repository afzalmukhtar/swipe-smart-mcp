...
class FinancialMCPServer:
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "category": {
                                "type": "string",
                                "description": "Expense category (optional, auto-detected if not provided)",
                            },
                            "payment_method": {
                                "type": "string",
                                "description": "Payment method (cash, credit-card, upi, etc.)",
                            },
                            "credit_card": {
                                "type": "string",
                                "description": "Credit card name (if payment_method is credit-card)",
                            },
                            "payment_portal": {
                                "type": "string",
                                "description": "Payment portal used (optional)",
                            },
                            "person": {
                                "type": "string",
                                "description": "Person who made the expense",
                            },
                            "date": {
                                "type": "string",
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "limit": {
                                "type": "integer",
                                "description": "Number of expenses to return (default: 10)",
                            },
                            "category": {
                                "type": "string",
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "period": {
                                "type": "string",
                                "description": "Period type: 'month', 'quarter', 'year', or 'custom'",
                            },
                            "year": {
                                "type": "integer",
                                "description": "Year (required for month/quarter/year)",
                            },
                            "month": {
                                "type": "integer",
                                "description": "Month (1-12, required for month)",
                            },
                            "quarter": {
                                "type": "integer",
                                "description": "Quarter (1-4, required for quarter)",
                            },
                            "start_date": {
                                "type": "string",
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "name": {
                                "type": "string",
                                "description": "Credit card name/nickname",
                            },
                            "bank": {"type": "string", "description": "Bank name"},
                            "reward_categories": {
                                "type": "object",
                                "description": "Reward categories and rates (e.g., {'dining': 3, 'groceries': 2, 'default': 1})",
                            },
                            "annual_fee": {
                                "type": "number",
                            ...
                            "bonus_categories": {
                                "type": "object",
                                "description": "Quarterly/temporary bonus categories",
                            },
                        },
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "analysis_type": {
                                "type": "string",
                                "description": "Type: 'trends', 'categories', 'cards', or 'rewards'",
                            },
                            "period": {
                                "type": "string",
    ...
    async def _handle_add_expense(self, args: dict[str, Any]) -> list[TextContent]:
        ...
        expense_data = {
            ...
            "date": datetime.strptime(
                args.get("date", datetime.now().strftime("%Y-%m-%d")), "%Y-%m-%d"
            ).date(),
        }
    ...
    async def _handle_list_expenses(self, args: dict[str, Any]) -> list[TextContent]:
        ...
        if not expenses:
            return [
                TextContent(
                    type="text", text="No expenses found matching the criteria."
                )
            ]
        ...
        return [
            TextContent(
                ...
                + "\n".join(
                    [
                        f"  • {method}: ${amount}"
                        for method, amount in summary["payment_methods"]
                    ]
                )
                + (
                    f"\n💰 Total Rewards Earned: ${summary['total_rewards']}"
                    if summary.get("total_rewards")
                    else ""
                ),
            )
        ]
